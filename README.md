...
| **Issues** | 32-check validation matrix (LNET_001–020 + IEC_001–016) + schema validation |
...
| `LNET_` | 001–020 | Landsnet site-specific rules (VLAN, APPID, timing, naming, …) |
...
src/
  ...
  validation/     32-check validation pipeline + schema validator
